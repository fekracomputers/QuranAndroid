...
public class HighlightImageView extends AppCompatImageView implements View.OnLongClickListener, View.OnTouchListener {
    ...
    public boolean onLongClick(View v) {
        ...
        if (!Settings.isMyServiceRunning(context, AudioService.class)) {
            mRects.clear();
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (QuranPageFragment.SELECTION && !Settings.isMyServiceRunning(context, AudioService.class)) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!QuranPageFragment.SELECTION) {
                    ...
                    if (Math.abs(deltaX) < 50) {
                        inAnimation = true;
                        ((QuranPageReadActivity) context).showHideToolBar();
                    }
                }
                break;
        }
    ...
    private void displayPopupWindow(int left, int top) {
        ...
        popupView = ((AppCompatActivity) context).getLayoutInflater().inflate(R.layout.popup_imageview, null);
    ...
    private void initPopup(View popupView) {
        ...
        play.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int internetStatus = Settings.checkInternetStatus(context);
                ...
                if (!Settings.isMyServiceRunning(context, AudioService.class)) {
                    ...
                    if (AppPreference.isStreamMood()) {
                        ...
                        if (!Settings.isMyServiceRunning(context, DownloadService.class)) {
                            //internal media play
        ...
        share.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, aya.text +
                        " (" + Settings.ChangeNumbers(context, aya.ayaID + "") + ") #QuranMindTrack");
        ...
        copy.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.content.ClipData clip = android.content.ClipData.newPlainText("Copied Text", aya.text + " (" + ayaID + ")" + " #" + context.getString(R.string.app_name));
